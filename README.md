...
The shows built into the car - Carol of the Bells, Auld Lang Syne, The Arrival and the rest of the list in Toybox - are part of the vehicle software rather than files in this repository. Where Tesla has published the sequence behind one, it is in the table above; [asking for another](https://github.com/teslamotors/light-show/issues) is a request for the maintainers. If all you have is a .fseq, [reading an existing .fseq](#reading_an_fseq) covers importing it back into xLights as a data layer.
